...
# This version is only for non-enable mode. It is bypassing the 020816.py version
# and using the 011216.py version

# Added support for the standard enable pound sign prompt and non enable prompt
# changed connections output to add a newline to the end of each line
#
# Changed nexus OS prompt to prompt <space> $
